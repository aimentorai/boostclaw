...
| Situation | Action |
|-----------|--------|
| Title may violate rules | Flag concern, suggest alternative |
| User provides title | Use user's title unless it clearly violates platform rules |
| Multiple product angles | Present 2-3 title options for user to choose |
| Content safety uncertain | Err on the side of caution, suggest safer wording |
