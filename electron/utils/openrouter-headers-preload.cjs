 ...
 * "openrouter.ai" carries the BoostClaw app-attribution headers.
 *
...
(function () {
  ...
  if (globalThis.__BoostClawFetchPatched) return;
  globalThis.__BoostClawFetchPatched = true;

  globalThis.fetch = function BoostClawFetch(input, init) {
    var url =
