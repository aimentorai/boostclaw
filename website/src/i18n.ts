...
export const i18n: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "usecases.creative.1":
      "睡前向 boostclaw 说明目标并设定自动执行，次日即可获得可用的雏形。",
    "usecases.creative.2":
      "从选题、找素材到确定方向，boostclaw 可协助完成视频内容创作全流程。",
    ...
    "usecases.productivity.3":
      "记录饮食与身体反应，由 boostclaw 定期分析并呈现规律。",
    "usecases.research.1":
    ...
    "quickstart.hintAfter": "，即可通过钉钉、飞书、QQ 等频道使用 boostclaw。",
    ...
    "quickstart.desc.script":
      "无需手动配置 Python，一行命令自动完成安装。脚本会自动下载 uv（Python 包管理器）、创建虚拟环境、安装 boostclaw 及其依赖（含 Node.js 和前端资源）。注意：部分网络环境或企业权限管控下可能无法使用。",
  ...
  en: {
    ...
    "follow.sub": "Follow us for the latest boostclaw updates",
    "follow.xiaohongshu": "Rednote:",
    "follow.x": "X:",
    "brandstory.title": "Why boostclaw?",
    "brandstory.para1":
      'boostclaw represents both a Co Personal Agent Workstation and a "co-paw"—a partner always by your side.',
    "brandstory.para2":
      'More than just a cold tool, boostclaw is a warm "little paw" always ready to lend a hand (or a paw!). It is the ultimate teammate for your digital life.',
    ...
    "usecases.title": "What you can do with boostclaw",
    "usecases.sub": "",
    ...
    "usecases.creative.1":
      "Describe your goal to boostclaw and set it to run overnight; get a working draft by the next day.",
    "usecases.creative.2":
      "From topic selection and material gathering to direction setting, boostclaw supports the full video content workflow.",
    "usecases.productivity.1":
    ...
    "usecases.productivity.3":
      "Log diet and symptoms; boostclaw analyzes and surfaces patterns over time.",
    "usecases.research.1":
    ...
    "quickstart.hintBefore":
      "Install → init → start. Configure channels to use boostclaw on DingTalk, Feishu, QQ, etc. See ",
    ...
    "quickstart.desc.script":
      "No Python setup required, one command installs everything. The script will automatically download uv (Python package manager), create a virtual environment, and install boostclaw with all dependencies (including Node.js and frontend assets). Note: May not work in restricted network environments or corporate firewalls.",
    "quickstart.desc.desktop":
    ...
    "quickstart.badgeBeta": "Beta",
    footer: "boostclaw — Works for you, grows with you",
