    ...
    <div data-testid="providers-settings" className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h2
          ...
          className="text-lg font-display text-foreground font-semibold tracking-tight"
        >
      ...
      {loading ? (
        ...
        >
          ...
          <p className="text-[13px] text-center mb-6 max-w-sm">{t('aiProviders.empty.desc')}</p>
          <Button
            onClick={() => setShowAddDialog(true)}
                  ...
                  >
                    ...
                    {[
                      ...
                      ...normalizeFallbackProviderIds(account.fallbackAccountIds)
                        .map(
                          (fallbackId) =>
                            allProviders.find((candidate) => candidate.account.id === fallbackId)
                              ?.account.label
                        )
                        .filter(Boolean),
                    ].join(', ')}
                  ...
                  {fallbackOptions.length === 0 ? (
                    ...
                    <div
                      className={cn(
                        ...
                        isDefault ? 'bg-white dark:bg-card' : 'bg-[#eeece3] dark:bg-muted'
                      )}
                    >
                          ...
                          {oauthError ? (
                            ...
                            <div className="space-y-5 w-full">
                              ...
                              <div className="flex items-center justify-center gap-3 p-4 bg-[#eeece3] dark:bg-muted border border-black/5 dark:border-white/5 rounded-xl shadow-inner">
                                <code className="text-2xl font-mono tracking-[0.2em] font-bold text-foreground">
                                  {oauthData.userCode}
                                </code>
                                <Button
                                  variant="ghost"
