...
export function Models() {
  ...
  const HIDDEN_USAGE_SOURCES = new Set(['gateway-injected', 'delivery-mirror']);
  ...
  const usageLoading =
    isGatewayRunning && fetchState.status === 'loading' && visibleUsageHistory.length === 0;
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between mb-12 shrink-0 gap-4">
          <div>
            <h1
              ...
              className="text-2xl font-display text-foreground mb-2 font-semibold tracking-tight"
            >
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div className="min-w-0">
                            ...
                            <p className="text-[13px] text-muted-foreground truncate mt-0.5">
                              {[
                                formatUsageSource(entry.provider),
                                formatUsageSource(entry.agentId),
                                entry.sessionId,
                              ]
                                .filter(Boolean)
                                .join(' • ')}
